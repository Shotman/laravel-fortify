    ...
    <div class="col-lg-5">        
        <div class="card mb-3">
            ...
            <div class="card-body">          
                ...
                <a href="{{ route('two-factor-authentication.toggle') }}" class="d-block mb-3">
                    @if(Auth::user()->two_factor_secret && !Auth::user()->two_factor_confirmed)
                    {{ __('Activate two factor authentication') }}
                    @elseif(!Auth::user()->secret && !Auth::user()->two_factor_confirmed)
                    {{__('Enable two factor authentication') }}
                    @elseif(Auth::user()->two_factor_secret && Auth::user()->two_factor_confirmed)
